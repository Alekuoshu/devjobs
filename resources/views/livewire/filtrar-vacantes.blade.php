                ...
                <div class="mb-5">
                    ...
                    <select wire:model="categoria" class="border-gray-300 p-2 w-full">
                        ...
                        @foreach ($categorias as $categoria )
                            <option wire:key='categoria-{{ $categoria->id }}' value="{{ $categoria->id }}">{{ $categoria->categoria }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <select wire:model="salario" class="border-gray-300 p-2 w-full">
                        ...
                        @foreach ($salarios as $salario)
                            <option wire:key='salario-{{$salario->id}}' value="{{ $salario->id }}">{{$salario->salario}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
